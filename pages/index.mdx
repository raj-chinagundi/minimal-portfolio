...
<a href="https://drive.google.com/file/d/1mrWTuuO5HMMysQjrb_uowGRbBOCL0PV7/view?usp=sharing" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', padding: '0.4rem 0.8rem', border: '1px solid #ccc', borderRadius: '4px', textDecoration: 'none', fontSize: '0.9rem', marginTop: '0.5rem' }}>Download Resume</a>
